...
Link para ver resultado: [VENTA VIAJES FINALIZADO](https://viajes-ejemplo-javascript.netlify.app/)
...
-   `tituloSeleccion`: el elemento de título (`<h1>`) donde se mostrará el título de la ciudad seleccionada.
-   `subtituloSeleccion`: el elemento de subtítulo (`<h3>`) donde se mostrará el subtítulo de la ciudad seleccionada.
-   `parrafoSeleccion`: el elemento de párrafo (`<p>`) donde se mostrará la descripción de la ciudad seleccionada.
-   `precioSeleccion`: el elemento donde se mostrará el precio de la ciudad seleccionada.
